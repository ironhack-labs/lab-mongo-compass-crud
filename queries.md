...
- **`query`**: {$and: [{founded_day: 1}, {category_code:{$ne: "web"}}]}
...
- **`query`**: {$and:[{'acquisition.acquired_year': 2014}, {'acquisition.acquired_month': "January"}]}
- //**`projection`**: {name: 1, \_id:0, acquisiton: 1}
